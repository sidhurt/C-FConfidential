...
| Pending MRN | S/4 (derived; `ZLE526`) | **T2**, synced from Datasphere through CPI | **30 minutes confirmed** by `SRC-SID-20260910-01`, resolving the MIGO cadence conflict in favor of the formal interface summary. The extraction queue and exact CPI/Datasphere trigger remain missing/unverified (Q-004/Q-053/C-12/C-14) |
...
| Storage location | S/4 | Commerce display | S/4 | Dispatch SLoc/SPI is populated during delivery enrichment; receiving SLoc is a receipt-side MIGO fact. Exact portal timing/locking remains unresolved. For MIGO, 10 Aug KT allocates receipt quantity across receiving storage locations; physical reconciliation is also product+SLoc grain (Q-004/Q-017/Q-083) |
...
| Transporter master/code | S/4 or Commerce TBD | CPI/Datasphere | S/4 posting | Master authority remains open. Working lifecycle: selected during outbound enrichment/dispatch and derived/copied at STO receipt rather than re-entered independently (D-071/Q-083) |
| Vehicle/driver details | Commerce input/master TBD | S/4 delivery/shipment/custom/FleetX | Process-dependent | Working lifecycle: captured before PGI on the dispatch side; copied/derived for STO receipt when required. Driver mobile is used for SMS. Exact delivery-versus-shipment-versus-ILMS authority remains Q-083 |
| LR/GR number and date | Dispatch-side S/4 delivery/shipment/ILMS — exact owner open | Commerce/Datasphere; receipt snapshot in `ZMMT_MIGO_HDR` | Outbound dispatch and STO receipt traceability | Do not ask the receiver to recreate the same transport document by default. Freeze the authoritative outbound object and FTP/FTB/EXW/rail exceptions under Q-083 |
