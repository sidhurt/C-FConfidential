...
| **C-12** | **STO source/path conflict; MIGO cadence now resolved.** D-014 says STO and MRN both DSP→T2 every 15 min. The 4 Aug meeting says S4→T2 direct and DSP→T2 four minutes apart. The formal interface summary separates them: STO orders/deliveries/invoices S4→T2 real-time, but MRN DSP→T2 batch. `SRC-SID-20260910-01` directly confirms the MIGO read model flows through CPI every 30 minutes. The exact trigger/interface and the STO path remain unresolved, and no delta queue exists for Pending MRN or STO in QS4 (D-038) | `SRC-ARCH-20260803-01`, `SRC-MTG-20260804-01`, `SRC-ARCH-20260811-01`, `SRC-CPI-20260811-01`, `SRC-SYS-20260805-07`, `SRC-SID-20260910-01` |
